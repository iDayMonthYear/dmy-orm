...
import cn.com.idmy.orm.core.provider.EntitySqlProvider;
...
public interface BaseMapper<T> {
     ...
     * @return 受影响的行数
     * @see cn.com.idmy.orm.core.provider.EntitySqlProvider#insert(Map, ProviderContext)
     */
    @InsertProvider(type = EntitySqlProvider.class, method = "insert")
    int insert(@Param(OrmConsts.ENTITY) T entity, @Param(OrmConsts.IGNORE_NULLS) boolean ignoreNulls);
     ...
     * @param ignoreNulls 是否忽略 {@code null} 值
     * @return 受影响的行数
     * @see cn.com.idmy.orm.core.provider.EntitySqlProvider#insertWithPk(Map, ProviderContext)
     */
    @InsertProvider(type = EntitySqlProvider.class, method = "insertWithPk")
    int insertWithPk(@Param(OrmConsts.ENTITY) T entity, @Param(OrmConsts.IGNORE_NULLS) boolean ignoreNulls);
     ...
     * @return 受影响的行数
     * @see cn.com.idmy.orm.core.provider.EntitySqlProvider#insertBatch(Map, ProviderContext)
     * @see OrmConsts#METHOD_INSERT_BATCH
     */
    @InsertProvider(type = EntitySqlProvider.class, method = OrmConsts.METHOD_INSERT_BATCH)
    int insertBatch(@Param(OrmConsts.ENTITIES) List<T> entities);
     ...
     * @param id 主键数据
     * @return 受影响的行数
     * @see cn.com.idmy.orm.core.provider.EntitySqlProvider#deleteById(Map, ProviderContext)
     */
    @DeleteProvider(type = EntitySqlProvider.class, method = "deleteById")
    int deleteById(@Param(OrmConsts.PRIMARY_VALUE) Serializable id);
     ...
     * @param ids 主键列表
     * @return 受影响的行数
     * @see cn.com.idmy.orm.core.provider.EntitySqlProvider#deleteBatchByIds(Map, ProviderContext)
     */
    @DeleteProvider(type = EntitySqlProvider.class, method = "deleteBatchByIds")
    int deleteBatchByIds(@Param(OrmConsts.PRIMARY_VALUE) Collection<? extends Serializable> ids);
    ...
    default int deleteByMap(Map<String, Object> whereConditions) {
        OrmAssert.notEmpty(whereConditions, "whereConditions");
    ...
    default int deleteByCondition(QueryCondition whereConditions) {
        OrmAssert.notNull(whereConditions, "whereConditions");
        return deleteByQuery(QueryWrapper.create().where(whereConditions));
    }
     ...
     * @return 受影响的行数
     * @see cn.com.idmy.orm.core.provider.EntitySqlProvider#deleteByQuery(Map, ProviderContext)
     */
    @DeleteProvider(type = EntitySqlProvider.class, method = "deleteByQuery")
    int deleteByQuery(@Param(OrmConsts.QUERY) QueryWrapper queryWrapper);
     ...
     * @return 受影响的行数
     * @see cn.com.idmy.orm.core.provider.EntitySqlProvider#update(Map, ProviderContext)
     */
    @UpdateProvider(type = EntitySqlProvider.class, method = "update")
    int update(@Param(OrmConsts.ENTITY) T entity, @Param(OrmConsts.IGNORE_NULLS) boolean ignoreNulls);
     ...
     * @param queryWrapper 条件
     * @return 受影响的行数
     * @see cn.com.idmy.orm.core.provider.EntitySqlProvider#updateByQuery(Map, ProviderContext)
     */
    @UpdateProvider(type = EntitySqlProvider.class, method = "updateByQuery")
    int updateByQuery(@Param(OrmConsts.ENTITY) T entity, @Param(OrmConsts.IGNORE_NULLS) boolean ignoreNulls, @Param(OrmConsts.QUERY) QueryWrapper queryWrapper);
     ...
     * @param id 主键
     * @return 实体类数据
     * @see cn.com.idmy.orm.core.provider.EntitySqlProvider#selectOneById(Map, ProviderContext)
     */
    @SelectProvider(type = EntitySqlProvider.class, method = "selectOneById")
    T selectOneById(@Param(OrmConsts.PRIMARY_VALUE) Serializable id);
     ...
     * @param ids 主键列表
     * @return 数据列表
     * @see cn.com.idmy.orm.core.provider.EntitySqlProvider#selectListByIds(Map, ProviderContext)
     */
    @SelectProvider(type = EntitySqlProvider.class, method = "selectListByIds")
    List<T> selectListByIds(@Param(OrmConsts.PRIMARY_VALUE) Collection<? extends Serializable> ids);
     ...
     * @param queryWrapper 条件
     * @return 数据列表
     * @see cn.com.idmy.orm.core.provider.EntitySqlProvider#selectListByQuery(Map, ProviderContext)
     */
    @SelectProvider(type = EntitySqlProvider.class, method = "selectListByQuery")
    List<T> selectListByQuery(@Param(OrmConsts.QUERY) QueryWrapper queryWrapper);
     ...
     */
    @SelectProvider(type = EntitySqlProvider.class, method = "selectListByQuery")
    List<Row> selectRowsByQuery(@Param(OrmConsts.QUERY) QueryWrapper queryWrapper);
    ...
    List<Object> selectObjectListByQuery(@Param(OrmConsts.QUERY) QueryWrapper queryWrapper);
