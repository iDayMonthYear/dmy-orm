...
import cn.com.idmy.orm.core.provider.RowSqlProvider;
...
import cn.com.idmy.orm.core.util.MapperUtil;
...
import static cn.com.idmy.orm.core.query.QueryMethods.count;
...
public interface RowMapper {
    ...
    int insert(@Param(OrmConsts.SCHEMA_NAME) String schema, @Param(OrmConsts.TABLE_NAME) String tableName, @Param(OrmConsts.ROW) Row row);
    ...
    int insertBySql(@Param(OrmConsts.SQL) String sql, @Param(OrmConsts.SQL_ARGS) Object... args);
    ...
    int insertBatchWithFirstRowColumns(@Param(OrmConsts.SCHEMA_NAME) String schema, @Param(OrmConsts.TABLE_NAME) String tableName, @Param(OrmConsts.ROWS) List<Row> rows);
    ...
    int deleteBySql(@Param(OrmConsts.SQL) String sql, @Param(OrmConsts.SQL_ARGS) Object... args);
    ...
    int deleteById(@Param(OrmConsts.SCHEMA_NAME) String schema, @Param(OrmConsts.TABLE_NAME) String tableName, @Param(OrmConsts.PRIMARY_KEY) String primaryKey, @Param(OrmConsts.PRIMARY_VALUE) Object id);
    ...
    int deleteBatchByIds(@Param(OrmConsts.SCHEMA_NAME) String schema, @Param(OrmConsts.TABLE_NAME) String tableName, @Param(OrmConsts.PRIMARY_KEY) String primaryKey, @Param(OrmConsts.PRIMARY_VALUE) Collection<?> ids);
    ...
    int deleteByQuery(@Param(OrmConsts.SCHEMA_NAME) String schema, @Param(OrmConsts.TABLE_NAME) String tableName, @Param(OrmConsts.QUERY) QueryWrapper queryWrapper);
    ...
    int updateBySql(@Param(OrmConsts.SQL) String sql, @Param(OrmConsts.SQL_ARGS) Object... args);
    ...
    int updateById(@Param(OrmConsts.SCHEMA_NAME) String schema, @Param(OrmConsts.TABLE_NAME) String tableName, @Param(OrmConsts.ROW) Row row);
    ...
    int updateByQuery(@Param(OrmConsts.SCHEMA_NAME) String schema, @Param(OrmConsts.TABLE_NAME) String tableName, @Param(OrmConsts.ROW) Row data, @Param(OrmConsts.QUERY) QueryWrapper queryWrapper);
    ...
    int updateBatchById(@Param(OrmConsts.SCHEMA_NAME) String schema, @Param(OrmConsts.TABLE_NAME) String tableName, @Param(OrmConsts.ROWS) List<Row> rows);
    ...
    int updateEntity(@Param(OrmConsts.ENTITY) Object entity);
    ...
    Row selectOneById(@Param(OrmConsts.SCHEMA_NAME) String schema, @Param(OrmConsts.TABLE_NAME) String tableName, @Param(OrmConsts.PRIMARY_KEY) String primaryKey, @Param(OrmConsts.PRIMARY_VALUE) Object id);
    ...
    List<Row> selectListBySql(@Param(OrmConsts.SQL) String sql, @Param(OrmConsts.SQL_ARGS) Object... args);
    ...
    List<Row> selectListByQuery(@Param(OrmConsts.SCHEMA_NAME) String schema, @Param(OrmConsts.TABLE_NAME) String tableName, @Param(OrmConsts.QUERY) QueryWrapper queryWrapper);
     ...
     */
    @SelectProvider(value = RowSqlProvider.class, method = RowSqlProvider.METHOD_RAW_SQL)
    Object selectObject(@Param(OrmConsts.SQL) String sql, @Param(OrmConsts.SQL_ARGS) Object... args);


    @SelectProvider(value = RowSqlProvider.class, method = RowSqlProvider.METHOD_RAW_SQL)
    Map selectFirstAndSecondColumnsAsMap(@Param(OrmConsts.SQL) String sql, @Param(OrmConsts.SQL_ARGS) Object... args);

    @SelectProvider(type = RowSqlProvider.class, method = "selectListByQuery")
    Map selectFirstAndSecondColumnsAsMapByQuery(@Param(OrmConsts.SCHEMA_NAME) String schema
            , @Param(OrmConsts.TABLE_NAME) String tableName, @Param(OrmConsts.QUERY) QueryWrapper queryWrapper);
     ...
     */
    @SelectProvider(value = RowSqlProvider.class, method = RowSqlProvider.METHOD_RAW_SQL)
    List<Object> selectObjectList(@Param(OrmConsts.SQL) String sql, @Param(OrmConsts.SQL_ARGS) Object... args);
    ...
    default long selectCount(String sql, Object... args) {
        ...
        if (object == null) {
            ...
            throw OrmExceptions.wrap("selectCount error, Can not get number value for sql: %s", sql);
        }
    }
     ...
     */
    @SelectProvider(type = RowSqlProvider.class, method = "selectListByQuery")
    List<Object> selectObjectListByQuery(@Param(OrmConsts.SCHEMA_NAME) String schema
            , @Param(OrmConsts.TABLE_NAME) String tableName, @Param(OrmConsts.QUERY) QueryWrapper queryWrapper);
