 ...
 * @author Michael
 */
public class OrmDefaultResultSetHandler extends DefaultResultSetHandler {
    ...
    public OrmDefaultResultSetHandler(Executor executor, MappedStatement mappedStatement, ParameterHandler parameterHandler,
    ...
    private void handleResultSet(ResultSetWrapper rsw, ResultMap resultMap, List<Object> multipleResults,
        ...
        try {
            if (parentMapping != null) {
                ...
                if (resultMap.getId().startsWith("cn.com.idmy.orm.core.row.RowMapper.selectFirstAndSecondColumnsAsMap")) {
