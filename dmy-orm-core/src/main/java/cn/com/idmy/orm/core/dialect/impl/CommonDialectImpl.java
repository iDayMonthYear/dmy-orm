 ...
 * 创建或获取方言请参考 {@link cn.com.idmy.orm.core.dialect.DialectFactory}
 */
public class CommonDialectImpl implements Dialect {
    ...
    public CommonDialectImpl() {
    }

    public CommonDialectImpl(LimitOffsetProcessor limitOffsetProcessor) {
        this.limitOffsetProcessor = limitOffsetProcessor;
    }

    public CommonDialectImpl(KeywordWrap keywordWrap, LimitOffsetProcessor limitOffsetProcessor) {
