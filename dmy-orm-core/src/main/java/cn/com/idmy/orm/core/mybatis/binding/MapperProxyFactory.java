...
public class MapperProxyFactory<T> {
    ...
    public T newInstance(SqlSession sqlSession, OrmConfiguration configuration) {
        final MapperProxy<T> mapperProxy = new MapperProxy<>(sqlSession, mapperInterface, methodCache, configuration);
