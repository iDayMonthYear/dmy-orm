...
public abstract class Where<T, CRUD extends Where<T, CRUD>> extends Crud<T, CRUD> {
    ...
    public @NotNull CRUD eqToday(boolean if0, @NotNull FieldGetter<T, LocalDateTime> field) {
    ...
    public @NotNull CRUD isTrue(boolean if0, @NotNull FieldGetter<T, Boolean> field) {
    ...
    public @NotNull CRUD eq(boolean if0, @NonNull Object id) {
    ...
    public @NotNull CRUD nulls(boolean if0, @NotNull FieldGetter<T, ?> field, @Nullable Object bol) {
    ...
    public @NotNull CRUD notBetween(boolean if0, @NotNull FieldGetter<T, ?> field, @Nullable Object[] pair) {
        return if0 ? notBetween(field, pair) : crud;
    }
