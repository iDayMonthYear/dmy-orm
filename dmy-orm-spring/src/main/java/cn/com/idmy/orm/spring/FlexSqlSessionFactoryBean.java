 ...
 *
 * <p>源于 {@link SqlSessionFactoryBean}，主要是用于构建 {@link OrmConfiguration }，而不是使用原生的 {@link Configuration}。
 *
...
public class FlexSqlSessionFactoryBean extends SqlSessionFactoryBean
    ...
    private SqlSessionFactoryBuilder sqlSessionFactoryBuilder = new OrmSqlSessionFactoryBuilder();

    private SqlSessionFactory sqlSessionFactory;

    private String environment = OrmConsts.NAME;
    ...
    public void setConfiguration(Configuration configuration) {
        if (configuration != null && !(configuration instanceof OrmConfiguration)) {
    ...
    protected SqlSessionFactory buildSqlSessionFactory() throws Exception {
        ...
        if (this.configuration != null) {
            ...
            xmlConfigBuilder = new XMLConfigBuilder(OrmConfiguration.class, this.configLocation.getInputStream(), null, this.configurationProperties);
            targetConfiguration = xmlConfigBuilder.getConfiguration();
        } else {
            LOGGER.debug(
                    () -> "Property 'configuration' or 'configLocation' not specified, using default Flex Configuration");
//            targetConfiguration = new Configuration();
            targetConfiguration = new OrmConfiguration();
...
//            this.transactionFactory == null ? new JdbcTransactionFactory() : this.transactionFactory,
                ...
                dataSource instanceof OrmDataSource ? dataSource : new OrmDataSource(OrmConsts.NAME, dataSource)));
