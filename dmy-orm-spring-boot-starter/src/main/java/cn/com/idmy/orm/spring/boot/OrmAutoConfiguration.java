...
import cn.com.idmy.orm.core.logicdelete.LogicDeleteProcessor;
import cn.com.idmy.orm.core.mybatis.OrmConfiguration;
import cn.com.idmy.orm.core.table.DynamicSchemaProcessor;
import cn.com.idmy.orm.core.table.DynamicTableProcessor;
import cn.com.idmy.orm.core.table.TableManager;
import cn.com.idmy.orm.core.tenant.TenantFactory;
import cn.com.idmy.orm.core.tenant.TenantManager;
import cn.com.idmy.orm.spring.FlexSqlSessionFactoryBean;
...
public class OrmAutoConfiguration implements InitializingBean {
    ...
    public OrmAutoConfiguration(OrmProperties properties, ObjectProvider<Interceptor[]> interceptorsProvider,
                                ...
                                ObjectProvider<OrmCustomizer> mybatisFlexCustomizerProvider
    ) {
    ...
    protected void applyConfiguration(SqlSessionFactoryBean factory) {
        OrmProperties.CoreConfiguration coreConfiguration = this.properties.getConfiguration();
        OrmConfiguration configuration = null;
